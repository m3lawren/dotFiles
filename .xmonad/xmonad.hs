...
--
myWorkspaces    = ["dev","web","chat","runners","web2","music","7","8","9"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Rhythmbox controls
    , ((modm .|. controlMask, xK_Home), io (spawn "/usr/bin/rhythmbox-client --no-start --play-pause"))
    , ((modm .|. controlMask, xK_Page_Up), io (spawn "/usr/bin/rhythmbox-client --no-start --previous"))
    , ((modm .|. controlMask, xK_Page_Down), io (spawn "/usr/bin/rhythmbox-client --no-start --next"))
